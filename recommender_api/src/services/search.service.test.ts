    ...
    it('calls skill resolver with required skills', async () => {
      ...
      (resolveAllSkills as Mock).mockResolvedValue({
        ...
        resolvedRequiredSkillRequirements: [{
          ...
          originalSkillId: 'skill-ts',
          originalSkillName: 'TypeScript',
          expandedSkillIds: ['skill-ts'],
          skillIdToName: new Map([['skill-ts', 'TypeScript']]),
        ...
        preferredSkillIds: [],
        skillIdToPreferredProficiency: new Map(),
        resolvedRequiredSkills: [{ skillId: 'skill-ts', skillName: 'TypeScript', minProficiency: 'proficient', preferredMinProficiency: null }],
        resolvedPreferredSkills: [],
      });
